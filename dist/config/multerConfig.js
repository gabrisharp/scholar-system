...
// Garantir que não haja fotos com mesmo nome
const random = () => Math.floor(Math.random() * 1000 + 2000);

exports. default = {
  fileFilter: (req, file, cb) => {
    if (file.mimetype !== 'image/png' && file.mimetype !== 'image/jpeg') {
      return cb(new _multer2.default.MulterError('Tipo inválido - Arquivo precisa ser PNG ou JPEG'));
    }
  ...
  storage: _multer2.default.diskStorage({
    ...
    // ↓ Utilizado para renomear arquivo subido
